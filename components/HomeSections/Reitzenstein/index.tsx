  ...
  <HomeSection>
    <StaticSection>
      ...
      <InfoSection>
        ...
        <Typography variant="body1">React, TS, Rellax</Typography>
      </InfoSection>
      ...
      <TextSection>
        ...
        <Typography variant="body1" paragraph>
          ...
          order is reordered on rerender while the parralax scoll represents the
          non-linear flow of the natural world. Which description is inversed?
        </Typography>
