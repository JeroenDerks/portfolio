...
// import dc_mobile from 'public/images/keesing_dc_mobile.jpg';
  ...
  return (
    <HomeSection>
      <StaticSection>
        ...
        <TextSection>
          <Typography variant="body1" paragraph>
            ...
            comprehensive and accurate reference information for ID documents
            and banknotes.
          </Typography>
          <Typography variant="body1" paragraph>
      ...
      <VisualSection>
        ...
        {/* <Image src={dc_mobile} alt="DocumentChecker promo mobile" /> */}
      </VisualSection>
    </HomeSection>
  );
};
