      ...
      <StaticSection>
        ...
        <TextSection>
          <Typography variant="body1" paragraph>
            Spotten is an app platform that makes parking for companies a
            breeze.
          </Typography>
          <Typography variant="body1" paragraph>
            Users can make reservations, start parking transactions, open
            parking barrier gates and control when their parking sessions ends.
            While admins can control all these processes from the Spotten
            dashboard.
          </Typography>
          <Typography variant="body1" paragraph>
